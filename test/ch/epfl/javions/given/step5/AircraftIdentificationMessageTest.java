...
class AircraftIdentificationMessageTest {
    ...
    void aircraftIdentificationMessageConstructorThrowsWhenAddressOrCallSignIsNull() {
        assertThrows(NullPointerException.class, () -> new AircraftIdentificationMessage(100, null, 0xA0, new CallSign("AFR13TL")));
        assertThrows(NullPointerException.class, () -> new AircraftIdentificationMessage(100, new IcaoAddress("3950D1"), 0xA0, null));
    }
