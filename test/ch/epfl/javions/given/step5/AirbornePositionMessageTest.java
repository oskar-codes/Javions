package ch.epfl.javions.given.step5;
...
class AirbornePositionMessageTest {
    ...
    void airbornePositionMessageConstructorThrowsWhenTimeStampIsInvalid() {
        ...
        assertDoesNotThrow(() -> new AirbornePositionMessage(0, new IcaoAddress("ABCDEF"), 1000, 0, 0, 0));
    }

    @Test
    void airbornePositionMessageConstructorThrowsWhenIcaoAddressIsNull() {
        assertThrows(NullPointerException.class, () -> new AirbornePositionMessage(100, null, 1000, 0, 0, 0));
    }
    ...
    void airbornePositionMessageConstructorThrowsWhenParityIsInvalid() {
        ...
        for (int i = -100; i <= 100; i += 1) {
            if (i == 0 || i == 1) continue;
            var invalidParity = i;
            assertThrows(IllegalArgumentException.class, () -> new AirbornePositionMessage(100, icaoAddress, 100, invalidParity, 0.5, 0.5));
        }
    }
    ...
    void airbornePositionMessageConstructorThrowsWhenXYAreInvalid() {
        ...
        for (var invalidXY = 1d; invalidXY < 5d; invalidXY += 0.1) {
            var xy = invalidXY;
            assertThrows(IllegalArgumentException.class, () -> new AirbornePositionMessage(100, icaoAddress, 100, 0, xy, 0.5));
            assertThrows(IllegalArgumentException.class, () -> new AirbornePositionMessage(100, icaoAddress, 100, 0, -xy, 0.5));
            assertThrows(IllegalArgumentException.class, () -> new AirbornePositionMessage(100, icaoAddress, 100, 0, 0.5, xy));
            assertThrows(IllegalArgumentException.class, () -> new AirbornePositionMessage(100, icaoAddress, 100, 0, 0.5, -xy));
        }
    }
